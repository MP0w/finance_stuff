    ...
    try {
      ...
      const aiTokensUsage = {
        used_ai_total_tokens:
          user.used_ai_total_tokens + result.usage.totalTokens,
        used_ai_prompt_tokens:
          user.used_ai_prompt_tokens + result.usage.promptTokens,
        available_ai_tokens:
          user.available_ai_tokens - result.usage.totalTokens,
      };
      try {
